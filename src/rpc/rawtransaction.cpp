...
{
    // Call into TxToUniv() to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) are not
    // available, so we query them here and push the data into the returned UniValue.
